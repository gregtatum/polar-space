...
Gun.prototype = {
	...
	fire : function() {
		...
		return function(x, y, speed, theta) {
			...
			//Start sound
			sound.setGain(0.1, 0, 0.001);
			sound.setFrequency(freq, 0, 0);


			//End sound
			sound.setFrequency(freq * 0.1, 0.01, 0.05);
			setTimeout(function() {
				// This is a hack, it's not working unless I setTimeout the second setGain.
				sound.setGain(0, 0.01, 0.05);
			}, 50)
		};
	}(),
